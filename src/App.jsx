  ...
  return (
    <div className="min-h-screen flex items-center justify-center" style={{ background: '#0A0A0F' }}>
      <div className="text-center">
        <div className="w-10 h-10 rounded-xl mx-auto mb-4 flex items-center justify-center animate-spin-slow"
          style={{ background: 'linear-gradient(135deg, #6366F1, #8B5CF6)' }}>
          <span className="text-white font-bold text-sm">K</span>
        </div>
        <p className="text-sm" style={{ color: '#6B7280' }}>Loading Kevin OS...</p>
      </div>
    </div>
  )
}
    ...
    <>
      <Routes>
        ...
        <Route element={<SidebarLayout toast={toast} />}>
          ...
          <Route path="/tasks" element={<Placeholder title="Tasks" breadcrumb="Tasks" description="Full task management with AI prioritization via OpenAI. Drag-and-drop kanban and list views coming in Phase 2." badge="OpenAI" />} />
